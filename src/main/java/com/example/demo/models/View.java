...
import java.math.*;
 ...
 /**
  * View Value Object.
  * This class is value object representing database table View
...
public class View implements Cloneable, Serializable {
    ...
    public View (int clientIdIn, int productIdIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two View instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(View valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass View, mapping to table View\n");
