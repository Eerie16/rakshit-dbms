...
import java.math.*;
  ...
  * This class is value object representing database table  Products
...
public class  Products implements Cloneable, Serializable {
    ...
    public  Products (int productIdIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two  Products instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping( Products valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass  Products, mapping to table  Products\n");
