...
import java.math.*;
 ...
 /**
  * Role Value Object.
  * This class is value object representing database table Role
...
public class Role implements Cloneable, Serializable {
    ...
    public Role (Integer userIdIn, String roleNameIn) {
    ...
    public void setAll(Integer userIdIn,
          String roleNameIn) {
          this.userId = userIdIn;
          this.roleName = roleNameIn;
    }
    ...
    /** 
     * hasEqualMapping-method will compare two Role instances
    ...
    public Object clone() {
        ...
        if (this.userId != null)
             cloned.setUserId(new Integer(this.userId.intValue())); 
        if (this.roleName != null)
