...
public class EmployeeDao {
     ...
     */
    public Employee getObject(Connection conn, int employeeId) throws NotFoundException, SQLException {
    ...
    public synchronized void create(Connection conn, Employee valueObject) throws SQLException {
          ...
          try {
               sql = "INSERT INTO Employee ( employeeId, position, salary, "
               + "city, dateOfJoining, gender, "
               + "lname, fname, plantId) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?) ";
               stmt = conn.prepareStatement(sql);

               stmt.setInt(1, valueObject.getEmployeeId()); 
               stmt.setString(2, valueObject.getPosition()); 
               stmt.setObject(3, valueObject.getSalary(), Types.INTEGER); 
               stmt.setString(4, valueObject.getCity()); 
               stmt.setDate(5, valueObject.getDateOfJoining()); 
               stmt.setString(6, valueObject.getGender()); 
               stmt.setString(7, valueObject.getLname()); 
               stmt.setString(8, valueObject.getFname()); 
               stmt.setObject(9, valueObject.getPlantId(), Types.INTEGER); 
    ...
    public void save(Connection conn, Employee valueObject) 
          ...
          String sql = "UPDATE Employee SET position = ?, salary = ?, city = ?, "
               + "dateOfJoining = ?, gender = ?, lname = ?, "
               + "fname = ?, plantId = ? WHERE (employeeId = ? ) ";
          PreparedStatement stmt = null;

          try {
              stmt = conn.prepareStatement(sql);
              stmt.setString(1, valueObject.getPosition()); 
              stmt.setObject(2, valueObject.getSalary(), Types.INTEGER); 
              stmt.setString(3, valueObject.getCity()); 
              stmt.setDate(4, valueObject.getDateOfJoining()); 
              stmt.setString(5, valueObject.getGender()); 
              stmt.setString(6, valueObject.getLname()); 
              stmt.setString(7, valueObject.getFname()); 
              stmt.setObject(8, valueObject.getPlantId(), Types.INTEGER); 
    ...
    public List searchMatching(Connection conn, Employee valueObject) throws SQLException {
          ...
          if (valueObject.getPosition() != null) {
              if (first) { first = false; }
              sql.append("AND position LIKE '").append(valueObject.getPosition()).append("%' ");
          }
          ...
          if (valueObject.getDateOfJoining() != null) {
              if (first) { first = false; }
              sql.append("AND dateOfJoining = '").append(valueObject.getDateOfJoining()).append("' ");
          }
    ...
    protected void singleQuery(Connection conn, PreparedStatement stmt, Employee valueObject) 
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setPosition(result.getString("position")); 
                   valueObject.setSalary((Integer)result.getObject("salary")); 
                   valueObject.setCity(result.getString("city")); 
                   valueObject.setDateOfJoining(result.getDate("dateOfJoining")); 
                   ...
                   valueObject.setPlantId((Integer)result.getObject("plantId")); 
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
          ...
          try {
              ...
              while (result.next()) {
                   ...
                   temp.setSalary((Integer)result.getObject("salary")); 
                   temp.setCity(result.getString("city")); 
                   temp.setDateOfJoining(result.getDate("dateOfJoining")); 
                   temp.setGender(result.getString("gender")); 
                   temp.setLname(result.getString("lname")); 
                   temp.setFname(result.getString("fname")); 
                   temp.setPlantId((Integer)result.getObject("plantId")); 
