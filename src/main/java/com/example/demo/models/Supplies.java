...
import java.math.*;
 ...
 /**
  * Supplies Value Object.
  * This class is value object representing database table Supplies
...
public class Supplies implements Cloneable, Serializable {
    ...
    public Supplies (int rawMaterialIdIn, int supplierIdIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two Supplies instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(Supplies valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass Supplies, mapping to table Supplies\n");
