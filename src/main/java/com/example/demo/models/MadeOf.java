...
import java.math.*;
 ...
 /**
  * MadeOf Value Object.
  * This class is value object representing database table MadeOf
...
public class MadeOf implements Cloneable, Serializable {
    ...
    public MadeOf (int productIdIn, int rawMaterialIdIn) {
    ...
    /** 
     * hasEqualMapping-method will compare two MadeOf instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(MadeOf valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass MadeOf, mapping to table MadeOf\n");
